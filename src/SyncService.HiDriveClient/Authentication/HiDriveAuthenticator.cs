...
namespace SyncService.HiDriveClient.Authentication
{
    public class HiDriveAuthenticator : IHiDriveAuthenticator
    {
        ...
        public const string RevokationUrl = OAuthUrl + "/revoke";
        ...
        public HiDriveAuthenticator(string clientId, string clientSecret, Func<HttpClientHandler> httpClientHandlerFactory = null)
        {
            ...
            _httpClientHandlerFactory = httpClientHandlerFactory ?? (() => new HttpClientHandler());
        }
        ...
        public async Task RevokeRefreshToken(string refreshToken)
        {
            ...
            using (var httpClient = new HttpClient(_httpClientHandlerFactory()))
            {
                ...
                var response = await httpClient.PostAsync(RevokationUrl, content);
                ...
                if (response.Content != null)
                {
                    ...
                    var authenticationError = JsonConvert.DeserializeObject<AuthenticationError>(responseString);
